...
This project is indexed by GitNexus as **nora-device-mng** (3621 symbols, 5239 relationships, 105 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
