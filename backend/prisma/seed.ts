...
const PERMISSION_MATRIX: Record<UserRole, Record<string, PermFlags>> = {
  SADMIN: { devices: CRUD, locations: CRUD, areas: CRUD, rooms: CRUD, maintenance: CRUD, maintenance_history: CRUD, inventory: CRUD, inventory_history: CRUD, attachments: CRUD, transfer: CRUD, users: CRUD, permissions: VIEW_UPDATE },
  ADMIN:  { devices: CRUD, locations: CRUD, areas: CRUD, rooms: CRUD, maintenance: CRUD, maintenance_history: CRUD, inventory: CRUD, inventory_history: CRUD, attachments: CRUD, transfer: CRUD, users: CRUD, permissions: VIEW_UPDATE },
  USER:   { devices: VIEW_ONLY, locations: VIEW_ONLY, areas: VIEW_ONLY, rooms: VIEW_ONLY, maintenance: NONE, maintenance_history: NONE, inventory: NONE, inventory_history: NONE, attachments: NONE, transfer: NONE, users: NONE, permissions: NONE },
};
