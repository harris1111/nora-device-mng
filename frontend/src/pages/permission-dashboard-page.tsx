...
const moduleLabels: Record<string, string> = { devices: 'Thiết bị', locations: 'Đơn vị', areas: 'Khu vực', maintenance: 'Bảo trì', attachments: 'Tệp đính kèm', transfer: 'Luân chuyển', users: 'Tài khoản', permissions: 'Phân quyền' };
