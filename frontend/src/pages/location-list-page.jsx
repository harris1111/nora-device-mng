...
import { getLocations, createLocation, updateLocationApi, deleteLocationApi } from '../api/device-api';
...
export default function LocationListPage() {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Không thể tạo vị trí');
    } finally {
      setCreating(false);
    }
  };
  ...
  const handleUpdate = async (id) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Không thể cập nhật vị trí');
    } finally {
      setSaving(false);
    }
  };
  ...
  const handleDelete = async (id, name) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Không thể xóa vị trí');
    }
  };
